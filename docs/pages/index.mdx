...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">使用Next.js和MDX<br className='sm:block hidden'/>制作美丽的网站</h1>
    <p className="subtitle">简单、强大、灵活的网站生成框架，<br className='sm:block hidden'/>包含<a className="nextjs-link" href="https://nextjs.org" target="_blank">Next.js</a>中您喜爱的一切</p>
    ...
    <div className="content-container">
      <Features>
        <Feature index={0} large centered id="docs-card" href="/docs/docs-theme/start">
          ...
          <h3>以分钟为单位<br className="show-on-mobile"/>全功率文档</h3>
        </Feature>
        <Feature index={1} centered className="card-with-border" href="/docs/guide/image">
          <div className="h-full flex flex-col justify-between">
            <h3>链接和图像<br className="show-on-mobile"/>总是<span className="font-light">优化的</span></h3>
            <p className='text-left mb-8'>Nextra自动转换Markdown链接和图像以使用[Next.js链接](https://nextjs.org/docs/routing/introduction#linking-between-pages)和[Next.js图像](https://nextjs.org/docs/basic-features/image-optimization#local-images)。没有慢速导航或布局变化。</p>
            <div>
        ...
        <Feature index={2} id="highlighting-card" href="/docs/guide/syntax-highlighting">
          <h3>高级语法<br className="show-on-mobile"/>突出显示解决方案</h3>
          <p>[Shiki](https://shiki.matsu.io)提供的性能良好且可靠的构建时语法突出显示.</p>
        </Feature>
        <Feature index={3} href="/docs/guide/i18n">
          <h3>I18n就像<br className="show-on-mobile"/>创建新文件一样简单</h3>
          <p className='mb-4'>用区域后缀命名页面文件，剩下的工作由Nextra和Next.js完成。</p>
          <I18n/>
        </Feature>
        <Feature index={4} centered style={{
          ...
          }}><a href="https://mdxjs.com/blog/v2" target="_blank" style={{ color: 'currentColor' }}>MDX 2</a>允许您在Markdown中使用组件, <br className="hide-medium"/>with huge performance boost since v1.</p>
        </Feature>
        <Feature index={5} centered className="feat-darkmode" style={{
          ...
          >包括<br/>黑暗<br/>模式</motion.h3>
        </Feature>
        <Feature index={6} large id="search-card" href="/docs/docs-theme/theme-configuration#search">
          <div style={{ zIndex: 2}}>
            <h3>全文搜索, <br/>需要零配置</h3>
            <p>Nextra在构建时自动为您的内容编制索引，并通过[FlexSearch](https://github.com/nextapps-de/flexsearch)执行令人难以置信的快速全文搜索.</p>
          </div>
        ...
        <Feature index={7} large id="fs-card" style={{
          ...
          <h3>通过Next.js的文件系统路由，<br/>直观地组织页面</h3>
        </Feature>
        <Feature index={8} id="a11y-card" className='card-with-border' style={{
          ...
          <h3>A11y作为首要任务</h3>
          <p>Nextra尊重系统选项，<br className="show-on-mobile"/>如<b>增加对比度</b>和<b>减少运动</b>。</p>
        </Feature>
        <Feature index={9} href="/docs/guide/ssg">
          <h3>混合渲染, <br/>next generation</h3>
          <p className='mr-6'>您可以利用Next.js的混合渲染功能，将Markdown内容包括[SSG](https://nextjs.org/docs/basic-features/pages#static-generation-recommended)，[SSR](https://nextjs.org/docs/basic-features/pages#server-side-rendering)和[ISR](https://nextjs.org/docs/basic-features/data-fetching/incremental-static-regeneration)。</p>
        </Feature>
        <Feature index={10} large>
          <h3>还有更多...</h3>
          <p>SEO / RTL Layout / 可插入主题 / 内置组件 / 上次Git编辑时间 / 多个文档...<br/>许多新的可能性有待探索。</p>
          <p className="subtitle"><Link className="!no-underline" href="/docs">开始使用Nextra →</Link></p>
        </Feature>
      </Features>
    </div>
  </div>
